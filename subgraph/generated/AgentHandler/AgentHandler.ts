...
export class AgentHandler extends ethereum.SmartContract {
  ...
  functionsForwarders(param0: Bytes): Address {
    let result = super.call(
      "functionsForwarders",
      "functionsForwarders(bytes32):(address)",
  ...
  try_functionsForwarders(param0: Bytes): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "functionsForwarders",
      "functionsForwarders(bytes32):(address)",
      [ethereum.Value.fromFixedBytes(param0)]
  ...
  requestToSource(param0: Bytes): Bytes {
    let result = super.call(
      "requestToSource",
      "requestToSource(bytes32):(bytes32)",
      [ethereum.Value.fromFixedBytes(param0)]
    );
  ...
  try_requestToSource(param0: Bytes): ethereum.CallResult<Bytes> {
    let result = super.tryCall(
      "requestToSource",
      "requestToSource(bytes32):(bytes32)",
      [ethereum.Value.fromFixedBytes(param0)]
  ...
  rewardDistributions(param0: Bytes, param1: BigInt): i32 {
    let result = super.call(
      "rewardDistributions",
      "rewardDistributions(bytes32,uint256):(uint8)",
      [
        ethereum.Value.fromFixedBytes(param0),
...
export class AddRewardMechanismCall__Inputs {
  ...
  get _rewardDistributions(): Array<i32> {
