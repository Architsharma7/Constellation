...
export class agentHandlerV3__agentsResult {
  value0: Address;
  value1: Address;
  value2: boolean;
...
export class agentHandlerV3__checkLogResult {
  value0: boolean;
  value1: Bytes;
...
export class agentHandlerV3__checkLogInputLogStruct extends ethereum.Tuple {
  get index(): BigInt {
...
export class agentHandlerV3__functionDataResult {
  value0: Address;
  value1: i32;
  value2: boolean;
...
export class agentHandlerV3__requestDataResult {
  value0: boolean;
  value1: Bytes;
...
export class agentHandlerV3 extends ethereum.SmartContract {
  static bind(address: Address): agentHandlerV3 {
    return new agentHandlerV3("agentHandlerV3", address);
  }
  ...
  agents(param0: BigInt): agentHandlerV3__agentsResult {
    let result = super.call("agents", "agents(uint32):(address,address,bool)", [
      ethereum.Value.fromUnsignedBigInt(param0)
    ]);

    return new agentHandlerV3__agentsResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBoolean()
    );
  ...
  try_agents(
    param0: BigInt
  ): ethereum.CallResult<agentHandlerV3__agentsResult> {
    let result = super.tryCall(
      "agents",
    ...
    return ethereum.CallResult.fromValue(
      new agentHandlerV3__agentsResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toBoolean()
      )
  ...
  checkLog(
    log: agentHandlerV3__checkLogInputLogStruct,
    param1: Bytes
  ): agentHandlerV3__checkLogResult {
    let result = super.call(
      "checkLog",
    ...
    return new agentHandlerV3__checkLogResult(
      result[0].toBoolean(),
      result[1].toBytes()
    );
  }
  ...
  try_checkLog(
    log: agentHandlerV3__checkLogInputLogStruct,
    param1: Bytes
  ): ethereum.CallResult<agentHandlerV3__checkLogResult> {
    let result = super.tryCall(
      "checkLog",
      "checkLog((uint256,uint256,bytes32,uint256,bytes32,address,bytes32[],bytes),bytes):(bool,bytes)",
      [ethereum.Value.fromTuple(log), ethereum.Value.fromBytes(param1)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new agentHandlerV3__checkLogResult(
        value[0].toBoolean(),
        value[1].toBytes()
      )
    );
  ...
  functionData(param0: Bytes): agentHandlerV3__functionDataResult {
    let result = super.call(
      "functionData",
    ...
    return new agentHandlerV3__functionDataResult(
      result[0].toAddress(),
      result[1].toI32(),
      result[2].toBoolean()
    );
  ...
  try_functionData(
    param0: Bytes
  ): ethereum.CallResult<agentHandlerV3__functionDataResult> {
    let result = super.tryCall(
      "functionData",
      "functionData(bytes32):(address,uint8,bool)",
      [ethereum.Value.fromFixedBytes(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new agentHandlerV3__functionDataResult(
        value[0].toAddress(),
        value[1].toI32(),
        value[2].toBoolean()
      )
  ...
  requestData(param0: Bytes): agentHandlerV3__requestDataResult {
    let result = super.call(
      "requestData",
    ...
    return new agentHandlerV3__requestDataResult(
      result[0].toBoolean(),
      result[1].toBytes()
    );
  }
  ...
  try_requestData(
    param0: Bytes
  ): ethereum.CallResult<agentHandlerV3__requestDataResult> {
    let result = super.tryCall(
      "requestData",
      "requestData(bytes32):(bool,bytes32)",
      [ethereum.Value.fromFixedBytes(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new agentHandlerV3__requestDataResult(
        value[0].toBoolean(),
        value[1].toBytes()
      )
    );
